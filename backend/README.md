...
## Project Structure
    ...
    ├── noah_cares_blockcha_39900  # Django project configurations
...
1. Clone this repo and `cd noah_cares_blockcha_39900`
...
2. Clone this repo and `cd noah_cares_blockcha_39900`
